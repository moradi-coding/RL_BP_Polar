...
//BCJR calclations using the [7,4] Hamming trellis in Vivian paper, calculations based on Ryan-Lin book (inefficient programming)
...
/*double s000_0_alpha,s000_1_alpha,s000_2_alpha,s000_3_alpha,s000_4_alpha,s000_5_alpha,s000_6_alpha,s000_7_alpha,
...
s111_4_alpha,s111_4_beta,s111_5_alpha,s111_5_beta,
...
gama4_11, gama5_00, gama5_00b, gama5_01b, gama5_01, gama6_00, gama6_01;*/ 
	...
	//for(a=0;a<num_cls;a++) {
		...
		if(tmp1>tmp2)
			...
			max1=tmp2;		
		s000_3_alpha= max1+log(1+exp(-1*abs(tmp1-tmp2)));
		...
		if(tmp1>tmp2)
			...
			max1=tmp2;		
		s010_3_alpha= max1+log(1+exp(-1*abs(tmp1-tmp2)));
		...
		if(tmp1>tmp2)
			...
			max1=tmp2;		
		s000_5_alpha= max1+log(1+exp(-1*abs(tmp1-tmp2)));
		...
		if(tmp1>tmp2)
			...
			max1=tmp2;		
		s001_3_alpha= max1+log(1+exp(-1*abs(tmp1-tmp2)));
		...
		if(tmp1>tmp2)
			...
			max1=tmp2;		
		s011_3_alpha= max1+log(1+exp(-1*abs(tmp1-tmp2)));
		...
		if(tmp1>tmp2)
			...
			max1=tmp2;		
		s101_5_alpha= max1+log(1+exp(-1*abs(tmp1-tmp2)));
		...
		if(tmp1>tmp2)
			...
			max1=tmp2;		
		s010_5_alpha= max1+log(1+exp(-1*abs(tmp1-tmp2)));
		...
		if(tmp1>tmp2)
			...
			max1=tmp2;		
		s101_6_alpha= max1+log(1+exp(-1*abs(tmp1-tmp2)));
		...
		if(tmp1>tmp2)
			...
			max1=tmp2;		
		s111_5_alpha= max1+log(1+exp(-1*abs(tmp1-tmp2)));
		...
		s000_6_alpha= max1+log(1+exp(-1*abs(tmp1-tmp2)));
		...
		if(tmp1>tmp2)
			...
			max1=tmp2;		
		s000_3_beta= max1+log(1+exp(-1*abs(tmp1-tmp2)));
		...
		if(tmp1>tmp2)
			...
			max1=tmp2;		
		s001_3_beta= max1+log(1+exp(-1*abs(tmp1-tmp2)));
		...
		if(tmp1>tmp2)
			...
			max1=tmp2;		
		s001_2_beta= max1+log(1+exp(-1*abs(tmp1-tmp2)));
		...
		if(tmp1>tmp2)
			...
			max1=tmp2;		
		s000_2_beta= max1+log(1+exp(-1*abs(tmp1-tmp2)));
		...
		if(tmp1>tmp2)
			...
			max1=tmp2;		
		s011_3_beta= max1+log(1+exp(-1*abs(tmp1-tmp2)));
		...
		if(tmp1>tmp2)
			...
			max1=tmp2;		
		s000_1_beta= max1+log(1+exp(-1*abs(tmp1-tmp2)));
		...
		if(tmp1>tmp2)
			...
			max1=tmp2;		
		s010_3_beta= max1+log(1+exp(-1*abs(tmp1-tmp2)));
		...
		if(tmp1>tmp2)
			...
			max1=tmp2;		
		s010_2_beta= max1+log(1+exp(-1*abs(tmp1-tmp2)));
		...
		if(tmp1>tmp2)
			...
			max1=tmp2;		
		s010_1_beta= max1+log(1+exp(-1*abs(tmp1-tmp2)));
		...
		if(tmp1>tmp2)
			...
			max1=tmp2;		
		s000_0_beta= max1+log(1+exp(-1*abs(tmp1-tmp2)));
